        ...
        <div class="table1">
            <form action="studentsignup.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input placeholder="username" name="username" type="varchar" class="form-control"
                        id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Email</label>
                    <input name="email" type="varchar" class="form-control" id="exampleInputPassword1"
                        placeholder="email">
                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Phone no.</label>
                    <input maxlength="10" minlength="10" type="int" name="phoneno" placeholder="phone no."
                ...
                <div class="mb-3">
                    ...
                    <input placeholder="confirm password" name="cpassword" type="password" class="form-control"
                        id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Service</label>
                    <input placeholder="Service" name="service" type="varchar" class="form-control"
                        id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Location</label>
                    <input placeholder="Location" name="location" type="varchar" class="form-control"
                        id="exampleInputPassword1">
                </div>
